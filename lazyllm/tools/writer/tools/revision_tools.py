...
''',
    ...
    def _revision_resolved_media(
        ...
        """Build the resolved media view for the plan's image-create instructions."""
        needs = [
            instr.visual_instruction
    ...
    def _validate_string_replace_images(
        ...
        """Reject malformed image-line replacements before they are applied."""
